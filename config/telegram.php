...
return [
    ...
    */
    'commands' => [
        \TicketsTelegram\Commands\StartCommand::class,
        \TicketsTelegram\Commands\CreatedTasks::class,
        \TicketsTelegram\Commands\TasksCommand::class,
        \TicketsTelegram\Commands\OnApproveTasks::class,
    ],
];
